...
const NavBar = (props) => {
  return (
    <>       
        ...
        <div class="navbar bg-base-100 px-32 py-5 border-b-4 border-current" data-theme="bumblebee">
            ...
            <div class=" hidden lg:flex">
                ...
                <div class="dropdown">
                    ...
                    <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-40 font-medium text-lg">
                    <li><Link to={'/productos'}>Products</Link></li> 
                        <li><a>About Us</a></li>                   
                        <li><a>Contact</a></li>
                    </ul>
